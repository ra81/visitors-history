...
declare namespace AmCharts {
    ...
    function makeChart(selector: string | HTMLElement, params: any, delay?: number): AmChart;
     ...
     * if none is passed.
     */
    function addInitHandler(handler: Function, types: string[]):void;
...
{"x": 20, "y": 20, "text": "this is label", "align": "left", "size": 12, "color": "#CC0000", "alpha": 1, "rotation": 0, "bold": true, "url": "http://www.amcharts.com"} */
        ...
        */
        ...
        /** Adds a label on a chart.
            ...
            url - url
        */
        addLabel(x: number|string, y: number|string, text: string, align: string, size?: number, color?: string, rotation?: number, alpha?: number, bold?: boolean, url?: string):void;
